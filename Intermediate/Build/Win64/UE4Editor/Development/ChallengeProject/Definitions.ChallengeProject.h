...
#define UE_PROJECT_NAME ChallengeProject
#define UE_TARGET_NAME ChallengeProjectEditor
#define UE_MODULE_NAME "ChallengeProject"
...
#define CHALLENGEPROJECT_API DLLEXPORT
